                    ...
                    <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
                        <div class="col-md-5 col-sm-5 col-xs-12 form-group top_search" style=" padding-left: 120px;">
                            <div class="input-group">
                                <a href="{{route('purchase.list')}}" class="btn btn-success"> View purchases</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                  ...
                  <form action="{{route('purchase.update',$purchase->id)}}" method="post">
                                ...
                                <label for="totalamount">Total Amount*</label>
                                    <input type="number" class="form-control" name="totalamount" value="{{$purchase->totalamount}}" id="totalamount" placeholder="Enter totalamount">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="paidamount" value="{{$purchase->paidamount}}" id="paidamount" placeholder="Enter paidamount">
                                    ...
                                    <input type="number" class="form-control" name="dueamount" value="{{$purchase->dueamount}}" id="dueamount" >
