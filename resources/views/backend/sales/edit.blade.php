            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                              <form action="{{route('sales.update',$sale->id)}}" method="post">
                                      ...
                                      <div class="form-group">
                                           ...
                                           <input type="number" min="1" class="form-control" id="sales_quantity" name="sales_quantity" value="{{$sale->quantity}}" placeholder="Quantity" required>
                                           <span class="error"><b>
                        ...
                        <input type="hidden" name="oldquantity" value="{{$oldquantity}}" required>
                         <div class="form-group">
                                ...
                                <div class="box-footer">
                                    <button type="submit" name="btnCreate" class="btn btn-primary">Update Sale</button>
                                </div>
                            </form>
                        </div>
                    </div>
