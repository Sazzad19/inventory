            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="row">
                            <form id="report" action="{{route('date.report')}}" method="post">
                                {{csrf_field()}}
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <button name="" id="report" type="submit" class="btn btn-info">Import Report</button>
                                </div>
                            </form>
                        </div>
                             <div class="row">

                            <form id="custreport" action="{{route('customer.report')}}" method="post">
                                {{csrf_field()}}
                                <div class="col-md-3">
                                    <input class="form-control"  type="text" name="code" placeholder="Enter Customer Code">
                                </div>
                               
                                <div class="col-md-3">
                                    <button name="" id="custreport" type="submit" class="btn btn-info">Import Report</button>
                                </div>
                            </form>
                             <form id="prodreport" action="{{route('product.report')}}" method="post">
                                {{csrf_field()}}
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <button name="" id="prodreport" type="submit" class="btn btn-info">Import Report</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    $('#custreport').on('submit', function (e) {
        e.preventDefault();
        var url = $(this).attr('action');
        var post = $(this).attr('method');
        var data = $(this).serialize();
...
$(document).ready(function () {
    ...
    $('#prodreport').on('submit', function (e) {
        e.preventDefault();
        var url = $(this).attr('action');
        var post = $(this).attr('method');
        var data = $(this).serialize();
