...
class ExpensesController extends Controller
{
    ...
    public function index()
    {
        ...
        $expenses = Expense::where('comp',session()->get('comp'))->orderBy('created_at', 'DEC')->get();
    ...
    public function create()
    {
        ...
        $expensesheading = Expensestitle::where('comp',session()->get('comp'))->orderBy('created_at', 'DEC')->get();
